...
class FolderDropZone(QFrame):
    ...
    def __init__(self):
        ...
        self.setFixedSize(800, 350)  # Increased height from 300 to 350
        self._setup_ui()
        self._apply_styles()
    ...
    def _setup_ui(self):
        ...
        layout.setSpacing(15)
        layout.setContentsMargins(40, 40, 40, 40)  # Add padding inside the box
        
        # Folder icon
        icon = QLabel("📁")
        icon.setAlignment(Qt.AlignCenter)
        icon.setFont(QFont("Segoe UI Emoji", 70))  # Slightly smaller icon
        ...
        title.setFont(QFont("Arial", 26, QFont.Bold))  # Slightly smaller title
        ...
        instructions.setFont(QFont("Arial", 15))
...
class EvidenceUpload(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.case_label.setFont(QFont("Arial", 24, QFont.Bold))
        ...
        self.progress_container.setFixedWidth(800)
        ...
        self.progress_title.setFont(QFont("Arial", 18, QFont.Bold))
        ...
        list_header.setFont(QFont("Arial", 18, QFont.Bold))
